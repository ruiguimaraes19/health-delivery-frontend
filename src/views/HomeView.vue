<script setup>
import heroImg from "@/assets/home/foto.png"; // se for .jpg -> "@/assets/foto.jpg"
</script>
  ...
  <main class="home">
    ...
    <section class="hero">
      <div class="container hero-wrap">
        <!-- Imagem principal (como no teu print) -->
        <div class="hero-image">
          <img :src="heroImg" alt="Health Delivery" />
        </div>

        <!-- Cards à direita (como no mockup) -->
        ...
        <div class="hero-center">
          ...
          <router-link to="/catalogo" class="btn btn-hd">PEDIR AGORA</router-link>
        </div>
      </div>
    </section>
